...
export default function Home() {
    ...
    return (
        <View style={styles.root}>
            <StatusBar backgroundColor="#5AA5E2"  />
            ...
            >
                ...
                >
                    <Typography style={styles.text} text="Welcome back" color="white" />
                    <Typography text="BANK EC" color="white" bold={true} fontSize={30} textAlign='center' />
